...
Template de page complète :  formulaire pour evaluer un produit

Paramètres :
    $evaluation: l'objet evaluation 
...
<body>
   ...
   <!--FORMULAIRE -->
   <form method= "POST" action= "enregistrer_note.php?idEval=<?= $evaluation->id() ?>" class= "affiche ">
