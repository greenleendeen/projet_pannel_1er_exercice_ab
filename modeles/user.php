<?php
// Classe user : gestion des objets utilisateurs (dépend totalement de l'application)

class user extends _model {

    // attributs à valoriser
    protected $table = "user";               // Nom de la table
    protected $fields = [ "login", "motdepasse", "nom" ];       // par exemple
   ...
   //     return $evaluation-> getEvalesByUser($user) ;
    }
...
//class user extends _model : terminé
        ...
        SELECT champ1, champ2,... , champN FROM table WHERE conditions
